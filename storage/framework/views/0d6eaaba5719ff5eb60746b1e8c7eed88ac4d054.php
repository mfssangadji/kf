...
<html lang="en">
   <head>
      ...
      <?php echo $__env->make('parts.stylesheet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <style type="text/css">
         .field-error {
             color: #db0700;
             font-size: 12px;
   ...
   <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
      ...
      <?php echo $__env->make('parts.plugin-scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php echo $__env->yieldContent('scripts'); ?>
   </body>
</html>
<?php /**PATH C:\xampp\htdocs\scripty\emil\resources\views/layouts/app.blade.php ENDPATH**/ ?>