...
unset($__errorArgs, $__bag); ?>
                     <input type="email" name="email" placeholder="Email pengguna" id="email" value="<?php echo e(old('email')); ?>" class="form-control <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                     <input type="text" placeholder="Nama lengkap pengguna" name="nama_lengkap" id="nama_lengkap" class="form-control <?php $__errorArgs = ['nama_lengkap'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                     <input type="text" placeholder="No telp pengguna" name="no_telp" id="no_telp" class="form-control <?php $__errorArgs = ['no_telp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                     <select class="form-control" name="apotik_id">
                        ...
                        <?php $__currentLoopData = $apotik; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $apotik): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <?php if(old('apotik_id') == $apotik->id): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\scripty\emil\resources\views/users/create.blade.php ENDPATH**/ ?>